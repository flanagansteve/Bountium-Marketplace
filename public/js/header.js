    ...
    return React.createElement("header", {className:"navbar navbar-expand"},
        ...
        React.createElement("div", {className:"col-10 mx-auto"},
          React.createElement("ul", {className:"nav navbar-collapse"},
            React.createElement("li", {className:"nav-item ml-auto"}, React.createElement("a", {href:"./work.html", className:"nav-link"}, "Fulfill Orders")),
            React.createElement("li", {className:"nav-item"}, React.createElement("a", {href:"./post.html", className:"nav-link"}, "Post Orders")),
