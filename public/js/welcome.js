...
window.addEventListener('load', async () => {
  ...
  ReactDOM.render(
    React.createElement("div", {className:"welcome-user-options"},
      ...
      React.createElement("a", {className:"btn btn-primary", href:"./post"}, "Post an Order"),
      React.createElement("a", {className:"btn btn-info float-right", href:"./work"}, "Fulfill Orders"),
    ),
